...
<section id="sidebar">
	...
	<ul class="side-menu">
		...
		<li><a href="users-list.php"><i class='bx bxs-chart icon'></i> Liste d'utilisateurs</a></li>
		<li><a href="comments-list.php"><i class='bx bxs-widget icon'></i> liste de commentaires</a></li>
